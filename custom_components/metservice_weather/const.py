...
SENSOR_MAP_PUBLIC: Final[dict[str, str]] = {
    ...
    "rainfall": "observations.rain.rainfall",
    "daily_rainfall_low": "rainFall1",
    "daily_rainfall_high": "rainFall10",
    "boating_status": "boating_status",
    "boating_forecast": "boating_forecast",
    "boating_table": "boating_table",
    # Surf — injected from regional surf page marker data
    ...
    # Wind — already fetched from currentConditions module, just unmapped
